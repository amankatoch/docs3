...
<img src="http://cms.oxpand.com/wp-content/uploads/2014/05/cms-header-newtva.jpg" style="text-align: right; margin-top: 30px; margin-left: 30px;" />       
...
<div id="leftdiv" style="float: right;margin-top: 0;position: absolute;right: 224px;top: 45px;margin:auto;">
	<?php get_sidebar( 'header' ); ?> 
</div>

 	   <div id ="flag"  style="top:45px !important;">    	
			<h3>
			Languages
			</h3>

                              <img src="http://cms.oxpand.com/wp-content/uploads/2014/05/Azerbaijan.png" />  
                               <img src="http://cms.oxpand.com/wp-content/uploads/2014/05/russia-flag.gif" />  
                               <img src="http://cms.oxpand.com/wp-content/uploads/2014/05/Union_flag_1606_Kings_Colors-svg.jpg">
