...
function pagination($start_end_links = 4, $middle_links = 4)
{
	...
	{			
		...
		{				
			// Pagination-Anfang
			echo '<div class="blogpages"><p>Page '.($current).' of '.($total).':</p><ul>';
