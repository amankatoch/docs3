<?php 
/* 
Template Name: Portfolio Sidebar Overview
*/ 
?>
...
<!-- MAIN CONTENT START-->
    ...
    <div id="contentcontainer"> 
        ...
        <div class="widget">
            <div class="headline"><?php echo $categoriestitle ?></div>
            <div class="sidebarportfoliomenu">
                <ul class="portfoliofilter_sidebar">
                   	<?php
					 echo '<li class="all"><a class="sidebarmenuselect" href="#"><span></span>All</a></li>';
					 foreach ( $terms as $term ) {
					   echo '<li class="'.strtolower($term->name).'"><a class="sidebarmenuselect_noselect" href="#"><span></span>'.$term->name.'</a></li>';
					 }
					?>
                </ul>
            </div> 
		...
		<?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
            ...
            <!-- PORTFOLIO -->
			<?php if ($sideb!=1){ ?>
            <ul id="portfoliolist1column" class="twothird_content right">
            <?php }else{ ?>
            <ul id="portfoliolist1column" class="twothird_content left">
            <?php } ?>
            <?php } ?>
            ...
            <?php if ($blogimageurl != "") { ?>
            <li class="blogpost" data-type="<?php echo $entrycategory ?>" data-id="id-<?php echo $currentindex ?>">
            <?php }else{ ?>
            <li class="blogpost noimage" data-type="<?php echo $entrycategory ?>" data-id="id-<?php echo $currentindex ?>">
            <?php } ?>
            	<?php if ($blogimageurl != "") { ?>
                <div class="blogimage rounded">
					...
					echo '<img src="'.get_bloginfo('template_url').'/functions/thumb.php?src='.$blogimageurl.'&amp;h=180&amp;w=180&amp;zc=1" alt="'.$entrytitle.'"/></a>';
					?>
                </div>
                <?php } ?>
