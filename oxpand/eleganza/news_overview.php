...
<?php
	if ( function_exists( 'get_option_tree') ) {
		$newspostcount = get_option_tree( 'value_news_postsperpage');
		$newsreadmorebutton = get_option_tree( 'button_news_readmore');
	}
    ...
    <div id="contentcontainer"> 
		...
		<?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
            ...
            <?php } ?>
                ...
                <div class="postinfo">
				Posted on <?php echo $timevar ?>.<br/>This Post has <span class="framed"><?php comments_popup_link('No Comments',
'1 Comment', '% Comments'); ?></span><br/><span class="framed"><?php the_tags('Tags: ',' '); ?></span>
       			</div>
                <div class="editorarea">
                <p><?php echo excerpt(50); ?></p>
                <div class="readmore"><a href="<?php the_permalink(); ?>" class="buttonlight rounded"><?php echo $newsreadmorebutton ?></a></div>
                <br style="clear: left" />
                </div>
                <br style="clear: left" />
            </div>
